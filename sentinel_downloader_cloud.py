...
# Nota: Los alias 'nir08', 'swir16' y 'red' mapean automáticamente a las bandas correctas
# en las colecciones Landsat C2 L2 (B4, B5, B3 para L5/L7 y B5, B6, B4 para L8/L9).
SAT_CONFIG = {
    "Sentinel-2": {
    ...
    "Landsat 5": {
        "collection": "landsat-c2-l2",
        "platform": ["landsat-5"],
        "assets": ["nir08", "swir16", "red"], # Mapea a B4, B5, B3 (TM)
        "res": 30,
        "tile_key": "landsat:wrs_path",
        "cloud_key": "eo:cloud_cover",
        "scale": 0.0000275,
...
st.markdown("---")
st.caption("Notas: Landsat 5 (1984-2013), Landsat 7 (1999-presente) y Landsat 8/9 (2013-presente). Los alias de bandas aseguran compatibilidad entre sensores.")