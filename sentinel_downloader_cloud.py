...
# El orden de assets garantiza que los primeros 3 sean la combinación solicitada (Color)
SAT_CONFIG = {
    "Sentinel-2": {
    ...
    "Landsat 1-3 (MSS)": {
        ...
        "assets": ["nir08", "red", "green"], # NIR, RED, GREEN (Sin SWIR)
        "res": 60,
        "tile_key": "landsat:wrs_path",
        "cloud_key": "eo:cloud_cover",
        "scale": 1.0, 
                ...
                with col1:
                    if st.button("🖼️ Vista Previa"):
                        ...
                        if producto == "Color (Infrarrojo/Natural)":
                            # Seleccionamos los primeros 3 (NIR, SWIR1, RED)
