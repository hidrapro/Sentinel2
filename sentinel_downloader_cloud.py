...
with st.sidebar:
    ...
    map_style = st.selectbox(
        "Estilo del Mapa",
        ["OpenStreetMap", "Terreno (Esri)", "Satélite (Esri)", "Topográfico (OpenTopo)"]
    )
...
# Lógica para cambiar los tiles dinámicamente
tile_urls = {
    "OpenStreetMap": "OpenStreetMap",
    "Terreno (Esri)": "https://server.arcgisonline.com/ArcGIS/rest/services/World_Terrain_Base/MapServer/tile/{z}/{y}/{x}",
...
attr_dict = {
    "Terreno (Esri)": "Tiles &copy; Esri &mdash; Source: USGS, Esri, TANA, DeLorme, and NPS",
    "Satélite (Esri)": "Tiles &copy; Esri &mdash; Source: Esri, i-cubed, USDA, USGS, AEX, GeoEye, Getmapping, Aerogrid, IGN, IGP, UPR-EGP, and the GIS User Community",
    "Topográfico (OpenTopo)": "Map data: &copy; OpenStreetMap contributors, SRTM | Map style: &copy; OpenTopoMap (CC-BY-SA)"
}
...
st.markdown("---")
st.caption("Soporte Landsat 8/9 & Sentinel-2 | Selección de Mapas Base | Normalización Robusta")