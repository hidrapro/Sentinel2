...
# en las colecciones Landsat C2 L2 (B4, B5, B3 para L4/L5/L7 y B5, B6, B4 para L8/L9).
SAT_CONFIG = {
    "Sentinel-2": {
...
st.markdown("---")
st.caption("Notas: Landsat 4 (1982-1993), Landsat 5 (1984-2013), Landsat 7 (1999-presente) y Landsat 8/9 (2013-presente).")