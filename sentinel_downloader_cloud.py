...
with st.sidebar:
    ...
    # Eliminado "Terreno (Esri)" por mal funcionamiento
...
# Lógica para cambiar los tiles dinámicamente sin la opción de Terreno
tile_urls = {
...
st.markdown("---")
st.caption("Soporte Landsat 8/9 & Sentinel-2 | Mapas Base Optimizados | Normalización Robusta")