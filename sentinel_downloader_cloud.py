...
# Cambiado a bandas de Color Verdadero (RGB) para evitar el tinte rojo
SAT_CONFIG = {
    "Sentinel-2": {
...
st.markdown("---")
st.caption("Balance de color corregido: Visualización en Color Verdadero (RGB) con normalización por canal.")